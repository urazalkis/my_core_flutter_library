...
class ElevatedCircularIconButton extends StatefulWidget {
  ...
  final double? width;
  @override
  _ElevatedCircularIconButtonState createState() =>
      _ElevatedCircularIconButtonState();
}

class _ElevatedCircularIconButtonState
    extends State<ElevatedCircularIconButton> {
  @override
