...
class NoNetworkAlertDialog extends StatefulWidget {
  final bool? isCoverScreen;
  const NoNetworkAlertDialog({super.key, this.isCoverScreen});
...
class _NoNetworkAlertDialogState extends State<NoNetworkAlertDialog> with StateMixin {
  ...
  final String checkYourNetworkText = "İnternet bağlantınızı kontrol edin";
  final String noConnectionErrorText = "İnternet bağlantısı sağlanamadı!";
  @override
  void initState() {
    super.initState();
